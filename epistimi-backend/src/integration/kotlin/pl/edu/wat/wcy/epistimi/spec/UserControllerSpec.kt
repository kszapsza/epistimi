...
internal class UserControllerSpec(
    ...
    forAll(
        ...
        should("return HTTP 403 on get by id endpoint if user is unauthorized ($role)") {
            // given
    ...
    forAll(
        ...
        should("return HTTP 403 on register user endpoint if user is unauthorized ($role)") {
            // given
