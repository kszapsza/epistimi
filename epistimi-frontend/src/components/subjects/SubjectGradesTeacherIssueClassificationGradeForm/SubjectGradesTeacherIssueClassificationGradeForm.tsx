...
import { Alert, Button, Checkbox, Radio, Select, TextInput } from '@mantine/core';
import { CLASSIFICATION_GRADE_SELECT_VALUES } from '../../../dto/grade-values';
import { ClassificationGradeIssueRequest, ClassificationGradePeriod } from '../../../dto/classification-grade';
...
export const SubjectGradesTeacherIssueClassificationGradeForm = (
  { subject, student, semester, onNewGradeIssued }: SubjectGradesTeacherIssueClassificationGradeFormProps,
): JSX.Element => {
