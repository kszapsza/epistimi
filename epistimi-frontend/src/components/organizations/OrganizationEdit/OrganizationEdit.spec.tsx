...
describe('OrganizationEdit component', () => {
  afterEach(() => {
    jest.resetAllMocks();
  });

  it.each([
    [OrganizationEditVariant.CREATE, /utwórz/i],
    [OrganizationEditVariant.UPDATE, /zapisz/i],
    ...
    await waitFor(() => {
      ...
      expect(administratorSelect.options[0].innerHTML).toBe('Wybierz administratora placówki');
      ...
      expect(directorSelect.options[0].innerHTML).toBe('Wybierz dyrektora placówki');
